...
// |-----------+-----------+-----------+-----------+-----------+-------------|    |-----------+-----------+-----------+-----------+-----------+-----------|
      KC_F13,   LT(7,KC_Z), LALT_T(KC_X),  KC_C,   LSFT_T(KC_D),   KC_V,              KC_M,   RSFT_T(KC_H), KC_SLSH, RALT_T(KC_DOT),  KC_UP,     KC_QUOT,
// |-----------+-----------+-----------+-----------+-----------+-------------|    |-----------+-----------+-----------+-----------+-----------+-----------|
      KC_PSCR,    OSL(5),     T_NUM,   LT(8,KC_ESC),    LGUI_T(KC_TAB),                 RCTL_T(KC_SPC),      KC_BSPC,    KC_LEFT,    KC_DOWN,    KC_RGHT
// `-----------+-----------+-----------+-----------+-------------------------'    `-----------------------+-----------+-----------+-----------+-----------'
),
